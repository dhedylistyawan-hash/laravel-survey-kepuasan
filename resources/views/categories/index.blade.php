    ...
    <div class="max-w-3xl mx-auto">
        <div class="bg-white dark:bg-gray-800 dark:text-gray-100 border dark:border-gray-700 shadow-2xl rounded-2xl p-8 border-2 border-green-100">
            <div class="flex justify-between items-center mb-6">
                ...
                <a href="{{ route('categories.create') }}" class="bg-gradient-to-r from-green-500 to-blue-500 hover:from-green-600 hover:to-blue-600 text-white font-bold py-2 px-5 rounded-xl transition shadow">Tambah Kategori</a>
            </div>
            @if(session('success'))
                    ...
                    <tbody class="bg-white dark:bg-gray-800 dark:text-gray-100 divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tr class="hover:bg-green-50">
                            ...
                            <td class="px-4 py-2 border text-center" style="min-width: 160px;">
                                <a href="{{ route('categories.edit', $category) }}" class="bg-gradient-to-r from-blue-500 to-blue-700 hover:from-blue-600 hover:to-blue-800 text-white font-bold py-1 px-4 rounded-xl mr-2 transition shadow">Edit</a>
                                <form action="{{ route('categories.destroy', $category) }}" method="POST" style="display:inline-block; margin-left: 2px;">
                                    @csrf
                                    @method('DELETE')
