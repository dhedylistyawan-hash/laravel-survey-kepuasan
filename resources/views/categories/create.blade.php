        ...
        <div class="bg-white dark:bg-gray-800 shadow-2xl rounded-2xl p-8 border-2 border-green-100">
            ...
            <form action="{{ route('categories.store') }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <input type="text" name="name" id="name" class="form-input w-full border-2 border-green-200 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-400 focus:border-green-400 transition" required autofocus>
                    @error('name')
                ...
                <div class="mb-6">
                    ...
                    <input type="number" name="order" id="order" class="form-input w-full border-2 border-green-200 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-400 focus:border-green-400 transition" value="0" min="0">
                ...
                <div class="flex justify-between">
                    ...
                    <button type="submit" class="bg-gradient-to-r from-green-500 to-blue-500 hover:from-green-600 hover:to-blue-600 text-white font-bold py-2 px-8 rounded-xl transition shadow-lg">Simpan</button>
                </div>
            </form>
        </div>
    </div>
