...
<div class="container mx-auto mt-8">
    <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6 max-w-md mx-auto">
        <h1 class="text-xl font-bold mb-4">Tambah Pertanyaan</h1>
        <form action="{{ route('questions.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="question_text" id="question_text" class="form-input w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400" required>
                @error('question_text')
                    <div class="text-red-600 text-sm mt-1">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="mb-4" id="optionsDiv" style="display:none;">
                ...
                <textarea name="options" id="options" class="form-input w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400"></textarea>
                @error('options')
                    <div class="text-red-600 text-sm mt-1">{{ $message }}</div>
                @enderror
            </div>
            <div class="flex justify-between">
                ...
                <button type="submit" class="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded transition">Simpan</button>
            </div>
        </form>
    </div>
</div>
